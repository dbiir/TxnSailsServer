...
public class Adapter {
    ...
    @Getter
    private CCType transitionLockCCType = CCType.NUM_CC;
    ...
    public void setNextCCType(CCType ccType) {
        ...
        if (nextCCType == currentCCType) {
            ...
            System.out.println("=====*===== All workers ready for transition" + (endTime - startTime) + "ms");
            ...
            System.out.println("=====*===== All workers finish transition" + (endTime - startTime) + "ms");
            endTime = System.currentTimeMillis();
